...
class _$_FirebaseAuthState implements _FirebaseAuthState {
  _$_FirebaseAuthState({this.userCredential});
  ...
  @override
  String toString() {
    return 'FirebaseAuthState(userCredential: $userCredential)';
  }
...
abstract class _FirebaseAuthState implements FirebaseAuthState {
  factory _FirebaseAuthState({final UserCredential? userCredential}) =
      _$_FirebaseAuthState;
