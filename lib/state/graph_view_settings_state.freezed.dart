...
mixin _$GraphViewSettingsState {
  ...
  @JsonKey(ignore: true)
  $GraphViewSettingsStateCopyWith<GraphViewSettingsState> get copyWith =>
...
abstract class $GraphViewSettingsStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      bool draw,
      bool firstMatchesDraw,
      bool secondMatchesDraw,
      bool winRate,
      bool firstWinRate,
      bool secondWinRate});
}
...
class _$GraphViewSettingsStateImpl implements _GraphViewSettingsState {
  _$GraphViewSettingsStateImpl(
      ...
      this.draw = true,
      this.firstMatchesDraw = true,
      this.secondMatchesDraw = true,
      this.winRate = true,
  ...
  @override
  @JsonKey()
  final bool secondWinRate;

  @override
  String toString() {
    return 'GraphViewSettingsState(matches: $matches, firstMatches: $firstMatches, secondMatches: $secondMatches, win: $win, firstMatchesWin: $firstMatchesWin, secondMatchesWin: $secondMatchesWin, loss: $loss, firstMatchesLoss: $firstMatchesLoss, secondMatchesLoss: $secondMatchesLoss, draw: $draw, firstMatchesDraw: $firstMatchesDraw, secondMatchesDraw: $secondMatchesDraw, winRate: $winRate, firstWinRate: $firstWinRate, secondWinRate: $secondWinRate)';
  }
...
abstract class _GraphViewSettingsState implements GraphViewSettingsState {
  factory _GraphViewSettingsState(
      {final bool matches,
      final bool firstMatches,
      final bool secondMatches,
      final bool win,
