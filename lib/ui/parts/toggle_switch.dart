...
class _ToggleSwitchState extends State<ToggleSwitch>
  ...
  Widget build(BuildContext context) {
    ...
    activeFgColor = widget.activeFgColor ?? Theme.of(context).accentTextTheme.bodyText1.color;
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: List.generate(widget.labels.length * 2 - 1, (index) {
            ...
            if (active) {
              bgColor =
                  widget.activeBgColors == null ? activeBgColor : widget.activeBgColors[index ~/ 2];
            }
            ...
            if (index % 2 == 1) {
              ...
              return GestureDetector(
                ...
                child: Container(
                  ...
                  constraints: BoxConstraints(maxWidth: _calculateWidth(widget.minWidth)),
                      ...
                      : Row(
                          ...
                          children: <Widget>[
                            Icon(
                              ...
                              color: fgColor,
                              size: widget.iconSize > (_calculateWidth(widget.minWidth) / 3)
  ...
  /// Handles selection
  Future _handleOnTap(int index) async {
  ...
  double _calculateWidth(double minWidth) {
    ...
    final totalLabels = widget.labels.length;

    /// Extra width to prevent overflow and add padding
    final extraWidth = 0.10 * totalLabels;
